...
# Add the missing APF stars.
legacy_names.append('48682')
legacy_names.append('110897')
legacy_names.append('117176')
legacy_names.append('158633')
...
legacy.to_csv('legacy_specmatch_with_apf.csv')
