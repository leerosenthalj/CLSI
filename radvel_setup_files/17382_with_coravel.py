...
data_folder = '~/Academics/Astronomy/Planets/rvdata/merged_datasets/'
...
params['gamma_j'] = radvel.Parameter(value=-617.8, linear=True, vary=False)
params['jit_j'] = radvel.Parameter(value=2.)
#params['gamma_CORAVEL'] = radvel.Parameter(value=-50.279, linear=True, vary=False)
params['gamma_CORAVEL'] = radvel.Parameter(value=355.3, linear=True, vary=False)
params['jit_CORAVEL'] = radvel.Parameter(value=5.)
