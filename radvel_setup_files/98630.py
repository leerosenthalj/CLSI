...
data = cpsutils.io.loadcps('98630', hires_rk=True, hires_rj=True,
...
params['gamma_j'] = radvel.Parameter(value=319.2, vary=False, linear=True)
params['jit_j'] = radvel.Parameter(value=1.5)
params['gamma_k'] = radvel.Parameter(value=315.5, vary=False, linear=True)
