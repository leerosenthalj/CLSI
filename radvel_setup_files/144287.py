...
def initialize_params():
    ...
    params['per1'] = radvel.Parameter(value=4499.0)
    params['tc1'] = radvel.Parameter(value=2456982.5)
    params['k1'] = radvel.Parameter(value=1714.0)
    params['e1'] = radvel.Parameter(value=0.455)
...
params['gamma_j'] = radvel.Parameter(value=1188.18, linear=True, vary=False)
