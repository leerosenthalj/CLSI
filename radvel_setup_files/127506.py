...
data = utils.read_from_csv('vst127506.csv', binsize=0.5)
data['time'] = data['jd']
...
def initialize_params():
    ...
    params['per1'] = radvel.Parameter(value=2791.0)
    params['tc1'] = radvel.Parameter(value=2457210.0)
    params['k1'] = radvel.Parameter(value=901.6)
    params['e1'] = radvel.Parameter(value=0.71)
    params['w1'] = radvel.Parameter(value=-2.04)
...
params['gamma_j'] = radvel.Parameter(value=-260.596, linear=True, vary=False)
