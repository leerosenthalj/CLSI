...
# radvel mcmc -s 3765.py -d 2019-2-19/master --maxGR 1.001 --minsteps 1000 --nsteps 10000 --minpercent 100
...
def initialize_params():
    ...
    params['w1']   = radvel.Parameter(value=-1.96)
    params['k1']   = radvel.Parameter(value=3.74)

    params['per2'] = radvel.Parameter(value=4551.)
    params['tp2']  = radvel.Parameter(value=2456197.)
    params['e2']   = radvel.Parameter(value=0.36)
    params['w2']   = radvel.Parameter(value=-2.66)
    params['k2']   = radvel.Parameter(value=1.9)
