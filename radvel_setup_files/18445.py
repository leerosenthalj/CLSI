...
#params['gamma_j'] = radvel.Parameter(value=-437.972)
#params['jit_j'] = radvel.Parameter(value=1.)
params['gamma_k'] = radvel.Parameter(value=-364.973)
