...
anybasis_params['per1'] = radvel.Parameter(value=5.885400)
anybasis_params['tc1'] = radvel.Parameter(value=2455946.629063)
anybasis_params['e1'] = radvel.Parameter(value=0)
anybasis_params['w1'] = radvel.Parameter(value=2.544690)
anybasis_params['k1'] = radvel.Parameter(value=4.260000)
anybasis_params['per2'] = radvel.Parameter(value=13.135400)
anybasis_params['tc2'] = radvel.Parameter(value=2455954.552025)
anybasis_params['e2'] = radvel.Parameter(value=0)
anybasis_params['w2'] = radvel.Parameter(value=-3.455228)
anybasis_params['k2'] = radvel.Parameter(value=2.360000)

time_base = 2455944.304848
anybasis_params['dvdt'] = radvel.Parameter(value=0.0)
anybasis_params['curv'] = radvel.Parameter(value=0.0)
data = pd.read_csv('/data/radvel/input_dir/45184/data/all_data/all_data.csv',
